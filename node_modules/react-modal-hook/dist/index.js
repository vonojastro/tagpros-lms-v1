...
var ModalRoot = React.memo(function (_a) {
    var modals = _a.modals, container = _a.container, _b = _a.component, RootComponent = _b === void 0 ? React__default.Fragment : _b;
    ...
    return mountNode
        ? ReactDOM.createPortal(React__default.createElement(RootComponent, null, Object.keys(modals).map(function (key) { return (React__default.createElement(ModalRenderer, { key: key, component: modals[key] })); })), mountNode)
        : null;
});
...
var ModalProvider = function (_a) {
    ...
    return (React__default.createElement(ModalContext.Provider, { value: contextValue },
        React__default.createElement(React__default.Fragment, null,
            children,
            React__default.createElement(ModalRoot, { modals: modals, component: rootComponent, container: container }))));
};
